...
src_package = 'libruby2.2'
dst_package = 'ruby2.2-tcltk'
...
mkdir_p "debian/#{dst_package}/usr/lib/ruby/2.2.0"
tk_lib_files.each do |f|
  src = File.join("debian/#{src_package}/usr/lib/ruby/2.2.0/#{f}")
  dst = File.join("debian/#{dst_package}/usr/lib/ruby/2.2.0/#{f}")
  mv src, dst
end
