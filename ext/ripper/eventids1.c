...
ripper_init_eventids1(void)
{
    ...
    ripper_id_assoc_splat = rb_intern_const("on_assoc_splat");
    ...
    ripper_id_qsymbols_add = rb_intern_const("on_qsymbols_add");
    ripper_id_qsymbols_new = rb_intern_const("on_qsymbols_new");
    ...
    ripper_id_symbols_add = rb_intern_const("on_symbols_add");
    ripper_id_symbols_new = rb_intern_const("on_symbols_new");
...
ripper_init_eventids1_table(VALUE self)
{
    ...
    rb_hash_aset(h, ID2SYM(id), INT2NUM(2));
    id = rb_intern_const("assoc_splat");
    rb_hash_aset(h, ID2SYM(id), INT2NUM(1));
    ...
    rb_hash_aset(h, ID2SYM(id), INT2NUM(7));
    ...
    rb_hash_aset(h, ID2SYM(id), INT2NUM(1));
    id = rb_intern_const("qsymbols_add");
    rb_hash_aset(h, ID2SYM(id), INT2NUM(2));
    id = rb_intern_const("qsymbols_new");
    rb_hash_aset(h, ID2SYM(id), INT2NUM(0));
    ...
    rb_hash_aset(h, ID2SYM(id), INT2NUM(1));
    id = rb_intern_const("symbols_add");
    rb_hash_aset(h, ID2SYM(id), INT2NUM(2));
    id = rb_intern_const("symbols_new");
    rb_hash_aset(h, ID2SYM(id), INT2NUM(0));
